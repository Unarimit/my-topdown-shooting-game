...
namespace TowerDefense.Towers.Placement
{
	...
	public class TowerPlacementGrid : MonoBehaviour, IPlacementArea
	{
		...
		/// <param name="sizeOffset"><see cref="Vector2Int"/> indicating size of object to center.</param>
		/// <returns><see cref="Vector2Int"/> containing the grid coordinates corresponding to this location.</returns>
